...
//Kelas ini digunakan untuk relay node MH tipe 1
public class nSensorRelay {
    ...
    //Untuk BEBA index node 3
    int indexNode = 2;
    int alamatNode = nodeAddress[indexNode];

    //Jika BAFE, maka nextHop nya adalah BEBA
    //Jika BEBA, maka nextHop nya adalah BABE 
    int nextHop = nodeAddress[indexNode + 1];
    
    //Jika BAFE, maka prevHop AFFE
    //Jika BEBA, maka prevHop BAFE
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (!dariArahBS) {
                        relayToNextHop(pesanDiterima, sn++, f.getSrcAddr());
                        return;
                    }
                    ...
                    if (code >= 1 && code <= 4 || code == 6) {
                        relayToPrevHop(pesanDiterima, sn++);
                    }
